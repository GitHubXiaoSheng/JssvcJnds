...
public class Yws_edu_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_yws_edu, container, false);
    }
    @Override
    public void onStart() {
        super.onStart();
        science_listview=getActivity().findViewById(R.id.edu_listview);
